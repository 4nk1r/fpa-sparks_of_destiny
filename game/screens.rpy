...
style choice_button_text is default:
    xalign 0.5 yalign 0.3 yoffset -7
    idle_color "#fff"
    hover_color "#fff"
...
screen quick_menu():
    ...
    if quick_menu and not renpy.get_screen('choice') and not renpy.get_screen('pause') and _window:
...
screen main_menu():
    ...
    imagemap:
        ground "gui/menu_ground.jpg"
        hover "gui/menu_hover.jpg"

        hotspot (268, 851, 227, 93) action Start() hovered [ Play ("sound", "audio/sounds/neon.mp3")]

        hotspot (516, 860, 296, 79) action ShowMenu("load") hovered  Play ("sound", "audio/sounds/neon.mp3")

        hotspot (847, 875, 303, 60) action ShowMenu("preferences") hovered  Play ("sound", "audio/sounds/neon.mp3")

        hotspot (1183, 863, 228, 80) action ShowMenu("about") hovered  Play ("sound", "audio/sounds/neon.mp3")

        hotspot (1443, 861, 194, 84) action Quit(confirm=not main_menu) hovered  Play ("sound", "audio/sounds/neon.mp3")
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(
        pattern=_("Страница {}"), auto=_("Автоматические сохранения"),
        quick=_("Быстрые сохранения"))

    use game_menu(title)

    fixed:
        xsize 1600 ysize 1200 xalign 1.0
